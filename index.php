	...
	<body>
		...
		<main>
			...
			<section id="nosotros" class="seccion">
				<div class="container">
					<p>Nam accumsan tellus tortor, at aliquet est sodales vitae. Praesent posuere nunc eget odio dapibus jejeekpo, sed cursus mauris tincidunt. Donec arcu et urna eleifend sodales. Sed at neque non leo tincidunt semper. In ligula enim, rutrum sit amet Lorem eu, congue dapibus.</p> 
				</div>
			</section>
			...
			<section id="contactenos" class="seccion">
				<iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=El%20Valle%20Loja%20Ecuador&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				<div class="container-fluid">
					<div class="row">
			...
			<div class="container">
				<div class="row">
					...
					<div class="columna columna-25 columna-mobile-100">
						...
						<ul>
							<li>pattylopez2306@gmail.com</li>
							<li>+593985686043</li>
							<li>El Valle calle Portoviejo entre Manta y Guayaquil<br>Loja - Ecuador</li>
						</ul>
					</div>
					<div class="columna columna-25 columna-mobile-100">
						<h3>
